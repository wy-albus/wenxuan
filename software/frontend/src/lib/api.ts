...
export const getPredictionSummary = (runId: string) => request<PredictionSummary>(`/api/predictions/${runId}/summary`);
...
export const sendPredictionNotification = (runId: string, payload: { target_email: string; model_id?: string; include_excel_link?: boolean; notification_type?: 'PREDICTION_SUCCESS' | 'EXPORT_SUCCESS'; site_no?: string }) => request<NotificationRecord>(`/api/predictions/${runId}/notify`, { method: 'POST', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify(payload) });
